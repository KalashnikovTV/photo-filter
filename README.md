...
Было создано приложение позволяющее добавить изображению css-фильтры и сохранить изображение с наложенными на него фильтрами. Изображение в приложение можно загрузить с компьютера или по url.

**Функциональность приложения:**

![photo-filter](https://user-images.githubusercontent.com/58827564/115973835-ad6d5880-a560-11eb-9389-748014040ece.png)
...
- При нажатии на кнопки Next picture и Prev picture загружается следующая/предыдущая картинка из [папки с картинками](https://github.com/rolling-scopes-school/stage1-tasks/tree/assets/images), расположенной на Github. Ссылка на картинку формируется с учётом времени суток и номера картинки.
...
**Watch => https://kalashnikovtv.github.io/photo-filter/**
